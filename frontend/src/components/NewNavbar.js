          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            >
              ...
              <NavDropdown title="Class" id="navbarScrollingDropdown">
                <NavDropdown.Item href="/purchase/grade10">
                  Grade 10
                </NavDropdown.Item>
                ...
                <NavDropdown.Divider />
                <NavDropdown.Item href="#action5">ALs</NavDropdown.Item>
              </NavDropdown>
              <Nav.Link href="/getpro">Store</Nav.Link>
              <NavDropdown title="Student" id="navbarScrollingDropdown">
                <NavDropdown.Item href="/#">Purchase Class</NavDropdown.Item>
                <NavDropdown.Item href="mypayments">
                  {" "}
                  Requested Classes
                </NavDropdown.Item>
              </NavDropdown>
